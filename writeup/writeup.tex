...
\fancyhead[C]{Candidate Number: 4022}
...
\begin{titlepage}
    \centering
    \vspace*{2cm}
    {\Huge\bfseries Computer Science NEA\\[0.5em] IvanChain \par}
    \vspace{2cm}
    {\Large\textbf{Candidate Name:} Ivan Leung \par}
    \vspace{0.5cm}
    {\Large\textbf{Candidate Number:} 4022 \par}
    \vspace{0.5cm}
    {\Large\textbf{Centre Number:} 22245 \par}
    \vspace{0.5cm}
    {\Large\textbf{Exam Board:} OCR \par}
    \vspace{0.5cm}
    {\Large\textbf{Course Code:} H446 \par}
    \vspace{2cm}
    {\Large\textbf{Date:} June 2025 \par}
    \vfill
\end{titlepage}
...
\\
This \href{https://youtu.be/bBC-nXj3Ng4?si=7UgRxuPQdJOzkzG4}{video}  by \href{https://www.youtube.com/@3blue1brown}{3Blue1Brown}
...
\begin{figure}[H]
  \centering 
  \includegraphics[width=1.1\textwidth]{ui.jpeg}
